                            ...
                            <div class="item">
                                <article class="featured">
                                    ...
                                    <figure>
                                        	...
                                        	<img src="${pageContext.request.contextPath}/Assets/upload/banner/${item.image}" alt="Sample Article">
                            ...
                            <article class="article col-md-12">
                                <div class="inner">
                                    ...
                                    <div class="padding">
                                        ...
                                        <ul id="ulthongtin">
                                            <li>
                                                <span class="saptt">Thể loại:</span>&nbsp;&nbsp;${phim.theloai }
                                            </li>
                                            <li>
                                                <span class="saptt">Thời lượng:</span>&nbsp;&nbsp;${phim.thoiluong }&nbsp;&nbsp;Phút
                                            </li>
                                            <li>
                                                <span class="saptt">Khởi chiếu:</span>&nbsp;&nbsp;<fmt:formatDate value="${phim.ngaycongchieu}" pattern="dd/MM/yyyy"/>
                                            </li>
                                        </ul>
                                        <footer>
                                            <a href="#" class="love">
